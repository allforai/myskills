...
Defines product-level level requirements: view mode, level grammar, objectives,
...
- `.allforai/game-design/product/level-design-spec.json`
- `.allforai/game-design/product/level-design-report.json`
...
```json
{
  "skill": "game-product/level-design-spec",
  "mode": "spec_validate",
  "input_paths": {
