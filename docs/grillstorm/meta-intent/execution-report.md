...
> Current terminal report: [authorized continuation 1](execution-report-resume-1.md). The report below records the earlier stop; workflow-state.json holds current state and all failure history is retained.
