# UI Forge Execution Playbook For OpenCode

This playbook adapts `ui-forge` into a OpenCode-friendly post-implementation UI
refinement workflow.
...
OpenCode should always begin with a triage block before editing:
...
After finishing, OpenCode should report:
