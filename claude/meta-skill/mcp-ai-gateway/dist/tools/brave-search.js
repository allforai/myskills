...
export function registerBraveSearch(server) {
    // Web search
    server.tool("brave_web_search", "Search the web using Brave Search. Returns titles, URLs, and descriptions.", {
    ...
    // Image search
    server.tool("brave_image_search", "Search for images using Brave Image Search. Returns image URLs, dimensions, and thumbnails.", {
    ...
    // Video search
    server.tool("brave_video_search", "Search for videos using Brave Video Search. Returns video URLs, thumbnails, and metadata.", {
