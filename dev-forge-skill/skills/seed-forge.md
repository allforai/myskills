...
前置：上游过期检测
      ...
      - task-inventory.json 在 seed-plan.json 生成后被更新
        → ⚠ 警告「task-inventory.json 在 seed-plan.json 生成后被更新，数据可能过期，建议重新运行 product-map」
      - product-map.json 在 seed-plan.json 生成后被更新
        → ⚠ 警告「product-map.json 在 seed-plan.json 生成后被更新，数据可能过期，建议重新运行 product-map」
