...
Defines the product pillars that guide design tradeoffs. Pillars are enforceable
...
- `.allforai/game-design/product/game-pillar-spec.json`
- `.allforai/game-design/product/game-pillar-report.json`
...
```json
{
  "skill": "game-product/game-pillar-spec",
  "mode": "spec_validate",
  "input_paths": {
...
Require 3-5 pillars unless the product is intentionally tiny. Check that each
