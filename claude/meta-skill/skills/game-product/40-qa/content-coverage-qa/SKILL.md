...
Validates that product content requirements are covered by data, art, UI,
...
```json
{
  "skill": "game-product/content-coverage-qa",
  "mode": "validate",
  "input_paths": {
...
routes to `game-data-table-generation`; missing art/UI/audio routes to the
