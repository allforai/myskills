...
> Schema details: `./docs/schema-reference.md#discovery-profile`
...
> Analysis principles: `./docs/analysis-principles.md`
...
> Card Schema details: `./docs/schema-reference.md#file-catalog`
...
> Schema details: `./docs/schema-reference.md#file-catalog` and `#code-index`
