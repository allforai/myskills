...
export function registerFluxImage(server: McpServer): void {
  server.tool(
    "flux_generate_image",
    "Generate image using FLUX 2 Pro via fal.ai. Top Elo score, excellent prompt adherence and photorealism.",
    fluxImageSchema,
    async (params) => {
      try {
