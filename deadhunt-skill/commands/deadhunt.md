...
- `${CLAUDE_PLUGIN_ROOT}/SKILL.md` — 目标、关键原则、注意事项
- `${CLAUDE_PLUGIN_ROOT}/docs/quick-start.md` — 快速开始
- `${CLAUDE_PLUGIN_ROOT}/docs/workflow.md` — 工作流详解
- `${CLAUDE_PLUGIN_ROOT}/docs/phase0-analyze.md` — Phase 0: 项目分析
- `${CLAUDE_PLUGIN_ROOT}/docs/auth-strategy.md` — 登录认证策略
- `${CLAUDE_PLUGIN_ROOT}/docs/phase1-static.md` — Phase 1: 静态分析
- `${CLAUDE_PLUGIN_ROOT}/docs/phase2-plan.md` — Phase 2: 测试计划
- `${CLAUDE_PLUGIN_ROOT}/docs/phase3-test.md` — Phase 3: 深度测试（索引文件，指向子文件）
- `${CLAUDE_PLUGIN_ROOT}/docs/phase3/overview.md` — Phase 3: 性能优化与分级策略
- `${CLAUDE_PLUGIN_ROOT}/docs/phase3/404-scanner.md` — Phase 3: 全局 404 监控 + Layer 1-5
- `${CLAUDE_PLUGIN_ROOT}/docs/phase3/intent-classification.md` — Phase 3: 死链意图判定
- `${CLAUDE_PLUGIN_ROOT}/docs/phase3/validation.md` — Phase 3: CRUD 闭环 + 数据展示 + 业务流程
- `${CLAUDE_PLUGIN_ROOT}/docs/phase3/convergence.md` — Phase 3: 多轮收敛机制
- `${CLAUDE_PLUGIN_ROOT}/docs/phase3/patrol.md` — Phase 3: Patrol 引擎（Flutter）
- `${CLAUDE_PLUGIN_ROOT}/docs/phase4-report.md` — Phase 4: 报告生成
- `${CLAUDE_PLUGIN_ROOT}/docs/phase5-supplement-test.md` — Phase 5: 补充测试
- `${CLAUDE_PLUGIN_ROOT}/docs/faq.md` — FAQ
