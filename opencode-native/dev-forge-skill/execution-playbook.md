# Dev Forge Execution Playbook For OpenCode

This playbook adapts the source `dev-forge` plugin into a OpenCode-friendly
...
- Translate host-specific orchestration syntax into normal OpenCode execution.
...
- source materials may describe interactive spike selection, but OpenCode should
...
At the end of a forge run, OpenCode should summarize:
