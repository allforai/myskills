...
Repository storage uses the suffix `.py.fixture` to keep normal test discovery from executing this marker-bearing fixture. The native acceptance setup copies it into a disposable project and renames it to `.py` before taking the baseline snapshot.
