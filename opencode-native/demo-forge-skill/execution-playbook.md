# Demo Forge Execution Playbook For OpenCode

This playbook adapts the source `demo-forge` plugin into a OpenCode-friendly
...
At the end of a demo-forge run, OpenCode should summarize:
