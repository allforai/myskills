---
name: product-review
description: Product-thinking critique of a shipped or running product. Names missing jobs, broken journeys, and borrowable competitor positioning. Advice only — never edits product code. Explicitly invoked by naming product-review. Same package as cross-exam; different protocol.
