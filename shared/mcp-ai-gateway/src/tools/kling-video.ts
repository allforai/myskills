...
export function registerKlingVideo(server: McpServer): void {
  server.tool(
    "kling_generate_video",
    "Generate video using Kling 2.1 Master via fal.ai. Best value at ~$0.03/sec, 4K support, native audio.",
    klingVideoSchema,
    async (params) => {
      try {
