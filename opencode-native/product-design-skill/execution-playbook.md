# Product Design Execution Playbook For OpenCode

This playbook adapts the `product-design` pipeline into a OpenCode-friendly workflow
...
- source files may describe many `AskUserQuestion` checkpoints, but OpenCode
...
## Review hub behavior in OpenCode
...
At the end of the pipeline, OpenCode should summarize:
