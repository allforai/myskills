...
详见 `./docs/deadhunt/fieldcheck/extractors.md`。
...
详见 `./docs/deadhunt/fieldcheck/matching.md`。
...
详见 `./docs/deadhunt/fieldcheck/matching.md` 的"全链路矩阵交叉验证"章节。
...
详见 `./docs/deadhunt/fieldcheck/report.md`。
