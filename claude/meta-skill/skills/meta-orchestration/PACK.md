...
| `40-qa` | `bootstrap-node-expansion-qa` | Audit every node-spec before `/run` for effect/quality completion standards, a bounded attention contract, and QA→repair→closure wiring (bootstrap-audits step 4). |
