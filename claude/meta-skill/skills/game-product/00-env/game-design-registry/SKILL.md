...
for product-design entities: features, systems, loops, resources, levels,
...
- `.allforai/game-design/product/game-design-registry.json`
- `.allforai/game-design/product/game-design-registry-report.json`
...
```json
{
  "skill": "game-product/game-design-registry",
...
Return `COMPLETED` when the registry is valid and every product entity has a
