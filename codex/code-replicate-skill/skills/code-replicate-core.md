...
4. 收集缺失参数（assume defaults where reasonable, only ask when missing answer would corrupt next phase）：
...
> 详见 ./docs/phase2/stage-a-structure.md
...
> 详见 ./docs/phase2/stage-b-runtime.md
...
> 详见 ./docs/phase2/stage-c-resources.md
...
> 详见 ./docs/phase2/stage-d-confirm.md
...
> 详见 ./docs/phase3/standard-artifact-steps.md

### Phase 4: Verify & Handoff

> 详见 ./docs/phase4/verify-handoff.md
...
Phase 2 Stage B 的 5 步（2.5-2.9）互相独立 → 可并行执行：

```
Stage B 并行:
  Parallel 1: 2.5 infrastructure-profile
  Parallel 2: 2.6 env-inventory + 2.7 third-party-services（共享 .env 文件读取）
  Parallel 3: 2.8 cron-inventory + 2.9 error-catalog
```
...
所有脚本位于 `../../shared/scripts/code-replicate/`：
