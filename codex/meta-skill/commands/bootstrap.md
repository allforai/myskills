...
- generate current-run completion artifacts under `.allforai/bootstrap/`; do not rely on existing `docs/bootstrap/*` files as the sole workflow completion signal
