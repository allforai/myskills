...
Validates whether product loops are closed: goal, action, feedback, reward,
...
Writes `.allforai/game-design/product/core-loop-closure-qa-report.json`.
...
```json
{
  "skill": "game-product/core-loop-closure-qa",
  "mode": "validate",
  "input_paths": {
