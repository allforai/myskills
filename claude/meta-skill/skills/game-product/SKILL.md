...
Game Product owns the product-design and game-planning decision chain before
...
40-qa         Is the product design closed, balanced, covered, and feasible?
```
...
| `10-concept` | `game-pillar-spec` | Product pillars, tradeoff rules, design constraints, and acceptance signals. |
...
| `30-generate` | `game-data-table-generation` | Program-readable JSON/CSV tables for systems, items, enemies, skills, levels, quests, and economy. |
| `30-generate` | `level-blockout-generation` | Playable blockout contracts, maps, encounter/reward placement, collision, and preview requirements. |
| `30-generate` | `enemy-roster-generation` | Enemy set, behaviors, stats, spawn roles, drops, art/VFX/audio/runtime requirements. |
| `30-generate` | `item-skill-generation` | Item, equipment, skill, status, icon, VFX, animation event, and data-table entries. |
...
```text
${CLAUDE_PLUGIN_ROOT}/skills/game-product/00-env/game-design-registry/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/10-concept/player-experience-contract/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/10-concept/game-pillar-spec/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/10-concept/core-game-loop-spec/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/20-spec/mechanics-spec/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/20-spec/progression-spec/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/20-spec/economy-spec/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/20-spec/level-design-spec/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/20-spec/combat-spec/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/20-spec/content-taxonomy-spec/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/20-spec/narrative-quest-spec/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/30-generate/game-data-table-generation/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/30-generate/level-blockout-generation/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/30-generate/enemy-roster-generation/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/30-generate/item-skill-generation/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/40-qa/core-loop-closure-qa/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/40-qa/progression-balance-qa/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/40-qa/economy-balance-qa/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/40-qa/content-coverage-qa/SKILL.md
${CLAUDE_PLUGIN_ROOT}/skills/game-product/40-qa/implementation-feasibility-qa/SKILL.md
```

## Shared Contracts

Game Product writes planning contracts under:

```text
.allforai/game-design/product/
...
-> 30-generate/game-data-table-generation
-> 30-generate/level-blockout-generation
-> 30-generate/enemy-roster-generation
-> 30-generate/item-skill-generation
...
30-generate/item-skill-generation -> game-art/30-generate/icon-generation
...
upstream product contracts and validation gates that those packs can consume.
