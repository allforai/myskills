...
description: Autonomous delivery of one large goal with design routed through Matt Pocock's official skills (grilling, to-spec, to-tickets, tdd, code-review), plus audit, handoff, and resume modes. User-invoked only via /grillstorm; never invoke it yourself.
---
