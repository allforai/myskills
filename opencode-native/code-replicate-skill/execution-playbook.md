# Code Replicate Execution Playbook For OpenCode

This playbook adapts `code-replicate` into a OpenCode-friendly reverse-engineering
workflow.
...
After execution, OpenCode should report:
