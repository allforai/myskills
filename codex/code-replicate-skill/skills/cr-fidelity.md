...
**维度层**（按需拉取）：
> 详见 ./docs/fidelity/static-dimensions.md
> 详见 ./docs/fidelity/ui-dimensions.md
> 详见 ./docs/fidelity/runtime-verification.md
...
> 详见 ./docs/fidelity/algorithm-dimensions.md

**I 维度**（关键基础设施，仅 infrastructure-profile 含 cannot_substitute 组件时）：
> 详见 ./docs/fidelity/infra-critical-dimensions.md

**B 维度**（ABI 兼容性，仅 archetype 为 SDK/Library 时）：
> 详见 ./docs/fidelity/abi-dimensions.md
...
> 详见 ./docs/fidelity/repair-protocol.md
