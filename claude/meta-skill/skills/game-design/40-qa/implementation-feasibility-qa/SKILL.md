...
Validates whether the game design can be implemented with the declared
engine, tools, runtime constraints, data contracts, and verification paths.

## Input Contract

Required: game-design registry and all selected design/system/content specs.
...
Writes `.allforai/game-design/design/implementation-feasibility-qa-report.json`.
...
```json
{
  "skill": "game-design/implementation-feasibility-qa",
  "mode": "validate",
  "input_paths": {
...
capability registry; data gaps route to `design-data-table-generation`; product
