...
- **`fix`** → 仅锻造：Phase 0 → 4 → 6（用已有 `testforge-analysis.json`，若分析文件时间早于最新 git commit 则警告并建议重新 analyze；若文件不存在则报错：「未找到 testforge-analysis.json，请先执行 `testforge analyze`」）
...
> 详见 ./docs/testforge/phase0-profile.md

---

## Phase 1：纵向审计 — tests ↔ 上游基准

> 详见 ./docs/testforge/phase1-vertical-audit.md
...
> 详见 ./docs/testforge/phase4-forge-loop.md
...
> 详见 ./docs/testforge/phase6-report.md
...
> 详见 ./docs/testforge/iron-rules.md
