# Code Tuner Execution Playbook For Codex Native

This playbook turns the source `code-tuner` plugin into a Codex-native workflow
...
After analysis, Codex should provide:
