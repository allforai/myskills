# codex/megastorm-skill/scripts/validate_plan_tasks.py
#!/usr/bin/env python3
...
megastorm is LANGUAGE-AGNOSTIC. A static script cannot read run output, so this
...
# your stack. Not a definition of "the languages megastorm supports" — just the
