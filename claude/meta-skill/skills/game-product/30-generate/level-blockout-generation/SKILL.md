...
Generates product-level level blockout contracts: layout diagrams, tile/map
...
```json
{
  "skill": "game-product/level-blockout-generation",
  "mode": "generate_validate",
  "input_paths": {
    "level_design": ".allforai/game-design/product/level-design-spec.json",
